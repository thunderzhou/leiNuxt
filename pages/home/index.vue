<template>
            ...
            <div class="col-md-9">
                ...
                >
                    <div class="article-meta">
                        ...
                        <button class="btn btn-outline-primary btn-sm pull-xs-right" :class="{'active': article.favorited}" @click="ifFavorite(article)" :disabled="article.favoriteDisabled">
  ...
  export default {
    ...
    watchQuery: ['page','tag','tab'],//使用watchQuery属性可以监听参数字符串的更改。 如果定义的字符串发生变化，将调用所有组件方法(asyncData, fetch, validate, layout, ...)
    computed: {
        ...mapState(['user']),
        totalPage () {
